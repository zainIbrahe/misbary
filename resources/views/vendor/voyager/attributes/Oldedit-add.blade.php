...
@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> asdasd
                                        ...
                                        <div class="col-md-3"
                                            ...
                                            <div class="form-group" style="width:100%">
                                                ...
                                                <select class="form-control changeAttr" name="types[]">
                                                    ...
                                                    <option value="7">Type Of Milage</option>
                                                    <option value="8">Engine Size</option>
                                                    <option value="9">Color</option>
                                                    <option value="10">Importing Country</option>
                                                    <option value="11">Fuel Type</option>
                                                    <option value="12">Transmission</option>
                                                    <option value="13">Seat Material Type</option>
                                                    <option value="14">Damaged parts</option>
                                                    <option value="15">Other Specifications</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3"
