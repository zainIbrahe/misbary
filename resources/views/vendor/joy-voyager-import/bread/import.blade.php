<a class="btn btn-info" id="bulk_import_btn"><i class="voyager-upload"></i>
    <span>{{ __('joy-voyager-import::generic.bulk_import') }}</span></a>

{{-- Bulk import modal --}}
<div class="modal modal-info fade" tabindex="-1" id="bulk_import_modal" role="dialog">
    <form action="/attributes/import" id="bulk_import_form" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <i class="voyager-upload"></i> {{ __('joy-voyager-import::generic.bulk_import_title') }} <span
                            id="bulk_import_count"></span> <span id="bulk_import_display_name"></span>
                    </h4>
                </div>
