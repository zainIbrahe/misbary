...
return [
    ...
    */
    ...
    'googlemaps' => [
        'key' => env('GOOGLE_MAPS_KEY', 'AIzaSyAWBPTuRAFdWEpdOd8cef3lHwOOK2DBlqo'),
        'center' => [
            'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '36.190337'),
            'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '44.007276'),
        ],
